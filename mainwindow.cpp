...
void MainWindow::on_pushButton_ListSouvenirs_clicked()
{
    ...
    else if(currentText =="Arizona State University")
    {
        qry->prepare("SELECT traditionalSouvenir, cost FROM souvenirs WHERE college=\"Arizona State University\"");
    }
    ...
    else if(currentText =="Saddleback College")
    {
        qry->prepare("SELECT traditionalSouvenir, cost FROM souvenirs WHERE college=\"Saddleback College\"");
    }
